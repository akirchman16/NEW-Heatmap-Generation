...
function [Counts,RAD51_Mon_Bound,RAD51_Dim_Bound,RPA_A_Bound_MicroDiss,RPA_A_Open_MicroBind,RPA_D_Bound_MicroDiss,RPA_D_Open_MicroBind] = LatticeSearch_Bound(DNA,n_RAD51,n_A,n_D)
    n_RPA = n_A+n_D;
    ...
    %Organize everything into neat arrays to record final counts and
    %locations
    Counts = [RAD51_Mon_Count,RAD51_Dim_Count,RPA_A_Hingeable_Count,RPA_A_Bindable_Count,RPA_D_Hingeable_Count,RPA_D_Bindable_Count];
    RAD51_Mon_Bound = RAD51_Mon_Pos;    RAD51_Dim_Bound = RAD51_Dim_Pos;
    RPA_A_Bound_MicroDiss = RPA_A_Bound_Hingeable;  RPA_A_Open_MicroBind = RPA_A_Open_Bindable;
    RPA_D_Bound_MicroDiss = RPA_D_Bound_Hingeable;  RPA_D_Open_MicroBind = RPA_D_Open_Bindable;
end